// enhanced-search-processor-updated.js - Background search processing Lambda with updated APIs
...
async function updateSearchStatus(requestId, status, additionalData = {}) {
    try {
        ...
        if (error.name === 'ResourceNotFoundException') {
            ...
            // Continue without status updates - don't crash the entire function
...
// Call Perplexity API with updated model
...
// Generate fallback events when APIs fail
